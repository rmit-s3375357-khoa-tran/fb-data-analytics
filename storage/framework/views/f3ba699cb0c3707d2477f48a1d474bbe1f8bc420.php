<div id="search-results-facebook" hidden>
    <div class="page-header text-center">
        <div class="row">
            <br><br>
            <p>
                <img class="social-media-logo" src="<?php echo e(asset('images/logos/Facebook-Logo-2.png')); ?>">
            </p>
        ...
        <div class="row">
            <?php for($i = 0; $i < 10; $i++): ?>
                <p class="col-xs-12" hidden>
                    <div class="col-xs-4">
                        <input
                                id="facebook-result-<?php echo e($i+1); ?>"
                                type="checkbox"
                        >
                    </div>
                    <div class="col-xs-8">
                        <span id="facebook-description-<?php echo e($i+1); ?>"></span>
                    </div>
                </p>
            <?php endfor; ?>
        </div>
