<div id="search-results-youtube" hidden>
    <div class="page-header text-center">
        <div class="row">
            <br><br>
            <p>
                <img class="social-media-logo" src="<?php echo e(asset('images/logos/youtube_2017_logo.png')); ?>">
            </p>
    ...
    <div class="container">
        <div class="row">
            <?php for($i = 0; $i < 13; $i++): ?>
                <div id="youtube-row-<?php echo e($i); ?>" class="col-xs-12" hidden>
                    <p>
                        <div class="col-xs-4">
                            <input
                                    id="youtube-id-<?php echo e($i); ?>"
                                    type="checkbox"
                                    class="youtube-video-id"
                                    <?php if($i>9): ?> checked <?php endif; ?>
                            >
                            <span id="youtube-title-<?php echo e($i); ?>"></span>
                        </div>
                        <div class="col-xs-2">
                            <span id="youtube-publish-<?php echo e($i); ?>"></span>
                        </div>
                        <div class="col-xs-6">
                            <span id="youtube-description-<?php echo e($i); ?>"></span>
                        </div>
                    </p>
                </div>
            <?php endfor; ?>
